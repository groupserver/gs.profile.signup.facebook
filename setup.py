...
setup(
    name='gs.profile.signup.facebook',
    version=version,
    ...
    url='https://github.com/groupserver/gs.profile.signup.facebook/',
    license='ZPL 2.1',
    ...
    install_requires=[
        ...
        'gs.content.form.base',  # For the status message content provider.
